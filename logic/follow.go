...
func (followService *FollowServiceImp) GetFollowers(userId int64) ([]model.User, error) {
	...
	// 根据粉丝数量创建空用户结构体数组
	userFollowers := make([]model.User, userFollowersCnt)
...
func (followService *FollowServiceImp) GetFriends(userId int64) ([]model.FriendUser, error) {
	...
	// 使用好友数量创建空好友结构体数组
	userFriends := make([]model.FriendUser, userFriendCnt)
...
func (followService *FollowServiceImp) BuildUser(userId int64, users []model.User, ids []int64, buildtype int) error {
	folowDao := mysql.NewFollowDaoInstance()
...
func (followService *FollowServiceImp) BuildFriendUser(userId int64, friendUsers []model.FriendUser, ids []int64) error {
